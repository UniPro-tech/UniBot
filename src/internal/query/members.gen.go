...
func newMember(db *gorm.DB, opts ...gen.DOOption) member {
	...
	_member.UserID = field.NewInt64(tableName, "user_id")
	_member.GuildID = field.NewInt64(tableName, "guild_id")
	_member.IsSuspended = field.NewBool(tableName, "is_suspended")
...
type member struct {
	...
	ALL         field.Asterisk
	UserID      field.Int64 // Discord User ID (Snowflake ID)
	GuildID     field.Int64 // Discord Guild ID (Snowflake ID)
	IsSuspended field.Bool  // Is this user suspended
...
func (m *member) updateTableName(table string) *member {
	...
	m.GuildID = field.NewInt64(table, "guild_id")
	m.IsSuspended = field.NewBool(table, "is_suspended")
...
func (m *member) fillFieldMap() {
	...
	m.fieldMap["guild_id"] = m.GuildID
	m.fieldMap["is_suspended"] = m.IsSuspended
